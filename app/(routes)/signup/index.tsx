...
export default function SignUp() {
  ...
  const handleSignUp = async () => {
    ...
    console.log("Password:", password); // Debugging password state
    setButtonSpinner(true);
    try {
      const response = await signUp({ email, meter_number: meterNumber, password1: password });
      showMessage({
        message: "Success",
        description: "Sign-up successful. Proceed to login!",
        type: "success",
