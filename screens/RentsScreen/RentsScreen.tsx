...
export default function RentsScreen() {
  ...
  return (
    <SafeAreaView style={styles.container}>
      <CustomHeader title="Rent Payment" showHistory={true} />
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <View style={{ paddingHorizontal: 20 }}>
          ...
          <Spacer size={16} />
          <Text style={styles.titleText}>Rent Status</Text>
          <Spacer size={8} />
          <View style={styles.cardContainer}>
            <View style={styles.rowContent}>
              <Text style={styles.textSubTitle}>Due Date</Text>
              <Spacer size={8} />
              <TouchableOpacity style={styles.selectDate}>
                <Text style={styles.textSubTitle}>Month</Text>
            ...
            >
              <Text style={styles.titleText}>26 October, 2024</Text>
              <Text
                style={{
                  color: "#E74C3C",
            ...
            <Text style={styles.textSubTitle}>
              Payment After the due date will incur additional fees
            </Text>
            <Spacer size={8} />
          </View>

          <Spacer size={16} />
          <Text style={styles.titleText}>Amount Per Year</Text>
          <Spacer size={8} />
          <View style={styles.cardContainer}>
            ...
            <View
              style={{ flexDirection: "row", justifyContent: "space-between" }}
            >
              <Text style={styles.titleText}>Break Down of the Payment</Text>
              <AntDesign name="down" size={18} />
            </View>
            <View style={styles.border}></View>

            <Text style={styles.textSubTitle}>
              This is the breakdown of the Charges That Apply
            </Text>
            <Spacer size={8} />
          </View>
          ...
          <View style={styles.cardContainer}>
            ...
            >
              ₦{totalAmount.toLocaleString()} Per {selectedYear}{" "}
              {selectedYear > 1 ? "years" : "year"}
            </Text>
            <Spacer size={8} />
          </View>
        </View>
      ...
      <View style={{ paddingHorizontal: 20 }}>
        ...
        >
          <Text style={styles.btnContent}>Make Payment</Text>
        </TouchableOpacity>
      </View>
      <Spacer size={20} />
